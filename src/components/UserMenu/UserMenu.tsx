      ...
      >
        {menuItems.map(item => (
          <li key={item.name}>
            <Link
              to={item.link}
              className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900 dark:text-white dark:hover:bg-gray-700"
              role="menuitem"
            >
              {item.name}
            </Link>
